...
// Gemini API utility (server-side)
// IMPORTANT: For production, set GEMINI_API_KEY in your environment. The fallback key is for demo/dev only and should not be used in production.
